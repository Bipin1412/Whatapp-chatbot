...
def mybot():
    ...
    if  incoming_msg == 'hi':
        ...
        body="Hi , Place your Ice-Cream Order here - (Format: MyOrder: FirstName LastName Quantity-Flavour City) || We have Strawberry , Vanilla , ButterScotch , Mango "
        )
        responded = True
    ...
    if 'who are you' in incoming_msg:
        ...
        to="whatsapp:+919284936420",
        from_="whatsapp:+14155238886",   
        body="I am a WhatsApp Order Placing ChatBot Developed By Group no. 7 for DBMS and ITL Project SY")
        responded=True
